...
var import_isLocaleRTL = require("./isLocaleRTL.cjs");
var import_jsx_runtime = require("react/jsx-runtime");
const defaultLocale = {
  direction: "ltr",
  locale: "en-US"
};
const LocaleContext = import_react.default.createContext(defaultLocale);
...
function LocaleProvider(props) {
  ...
  return needsContext ? /* @__PURE__ */(0, import_jsx_runtime.jsx)(LocaleContext.Provider, {
    value: {
