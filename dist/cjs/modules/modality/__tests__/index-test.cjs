...
(0, import_dom_event_testing_library.describeWithPointerEvent)("modules/modality", hasPointerEvent => {
  let rootNode;
  beforeEach(() => {
    (0, import_dom_event_testing_library.setPointerEvent)(hasPointerEvent);
  ...
  afterEach(() => {
    ...
    rootNode = null;
    (0, import_dom_event_testing_library.clearPointers)();
    (0, import__.testOnly_resetActiveModality)();
  });
  describe("getModality", () => {
    (0, import_dom_event_testing_library.testWithPointerType)("reflects currently-in-use modality", pointerType => {
      ...
      expect((0, import__.getModality)()).toBe("keyboard");
      target.pointerdown({
        pointerType
      });
      expect((0, import__.getModality)()).toBe(pointerType);
      target.pointerup({
        pointerType
      });
      target.keydown();
  ...
  describe("getActiveModality", () => {
    (0, import_dom_event_testing_library.testWithPointerType)("reflects last actively used modality", pointerType => {
      ...
      expect((0, import__.getActiveModality)()).toBe(pointerType);
      target.pointerup({
        pointerType
      });
      target.keydown();
